import { Box, Button, Divider, Grid, GridItem, Heading, Select, Text } from '@chakra-ui/react';
...
export default function PladgeEditList() {
  return (
    <Box backgroundColor="GhostWhite" pl="44px" pr="44px" className="container">
      <Heading pb="32px" pt="32px" className="headingText">
        Girov seçimi
      </Heading>
      ...
      <Box mt="20px" mb="20px" className="bottomBar">
        <Grid templateColumns="2fr 2fr" display="flex" justifyContent="space-between">
          <GridItem>
            <Button mt={'12px'} color={'#fff'} bg={'red'}>
              Ləvğ et
            </Button>
          </GridItem>
          <GridItem display="flex" gap="16px" alignItems="center" justifyContent="end">
            <Button mt={'12px'} border={'1px solid gray'} borderRadius={'5px'}>
              Başqa müştəri axtar
            </Button>
